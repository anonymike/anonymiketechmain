...
export default function DynamicOfferBanner() {
  ...
  const [currentBanner, setCurrentBanner] = useState<BannerContent | null>(
    null,
  );
    ...
    const updateBanner = () => {
      ...
      if (currentDay === 6 || currentDay === 0) {
        ...
        if (isOfferActive) {
          banner = {
            ...
            subtitle:
              "All-day weekend pricing now live! Unlimited savings until Monday!",
            bottomText:
              "🌟 Weekend warriors get the best VPN deals - grab yours now!",
          ...
          banner = {
            ...
            bottomText:
              "🌅 Weekend vibes - but don't forget your VPN security!",
      ...
      // Before Daily Offer (Before 6:00 PM)
        ...
        banner = {
          ...
          bottomText:
            "🎯 Set your reminder - exclusive VPN deals dropping soon!",
      ...
      // After Daily Offer (After 9:30 PM)
        ...
        const hoursUntilTomorrow = Math.floor(
      ...
      if (today.includes("Dec 25")) {
        // Christmas
        banner = {
          icon: "🎄",
          title: "CHRISTMAS SPECIAL OFFERS!",
          subtitle: "Ho ho ho! Extra special VPN deals for the holidays!",
          bottomText:
            "🎁 Our Christmas gift to you - premium VPN at holiday prices!",
          gradient: "from-green-900/80 to-red-900/50",
          titleColor: "text-green-300",
          glowColor: "text-green-400",
          borderColor: "border-green-500/50",
        };
      } else if (today.includes("Jan 1")) {
        // New Year
        banner = {
          icon: "🎊",
          title: "NEW YEAR, NEW VPN DEALS!",
          subtitle:
            "Start 2025 with ultimate online security at amazing prices!",
          bottomText:
            "🥳 New year resolution: Stay secure online with ANONYMIKETECH!",
          gradient: "from-gold-900/80 to-yellow-900/50",
          titleColor: "text-gold-300",
          glowColor: "text-gold-400",
