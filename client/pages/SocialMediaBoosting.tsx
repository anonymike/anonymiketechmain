  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setLiveCounts((prev) => ({
        ...
        engagement: +(prev.engagement + (Math.random() * 0.1 - 0.05)).toFixed(
          1,
        ),
      }));
    }, 3000);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              >
                ...
                >
                  ...
                  <div className="text-xs text-hacker-green-dim">
                    See how your account could grow with our services
                  </div>
                </motion.div>
              </motion.div>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <h4 className="text-xl font-tech font-bold text-hacker-green-bright mb-4">
                      {platformIcons[platforms[selectedPlatform]?.name] || "📱"}{" "}
                      {platforms[selectedPlatform]?.name} Services
                    </h4>
              ...
              <div className="glow-border rounded-lg p-8 bg-hacker-terminal/50 backdrop-blur-sm">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="text-hacker-green-dim mb-6">
                    ...
                    <div className="flex justify-center gap-6">
                      {Object.entries(
                        ...
                        >
                          ...
                          <div className="text-xs text-hacker-green-dim capitalize">
                            {key}
                          </div>
                        </motion.div>
                      ))}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  >
                    <div className="bg-red-900/20 border-2 border-red-500/30 rounded-lg p-6 mb-4">
                      <h4 className="text-2xl font-tech font-bold text-red-400 mb-4">
                        😞 BEFORE
                      </h4>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <span className="text-hacker-green-dim">
                            Followers:
                          </span>
                          <span className="text-red-400 font-tech font-bold">
                            1,200
                          </span>
                        </div>
                        <div className="flex items-center justify-between">
                  ...
                  >
                    <div className="bg-green-900/20 border-2 border-green-500/30 rounded-lg p-6 mb-4">
                      <h4 className="text-2xl font-tech font-bold text-green-400 mb-4">
                        🚀 AFTER
                      </h4>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          >
                            15,800{" "}
                            <span className="text-yellow-400">(+1,216%)</span>
                          </motion.span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-hacker-green-dim">
                          ...
                          >
                            8.7%{" "}
                            <span className="text-yellow-400">(+278%)</span>
                          </motion.span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-hacker-green-dim">
                          ...
                          >
                            25,000{" "}
                            <span className="text-yellow-400">(+4,900%)</span>
                          </motion.span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-hacker-green-dim">
                          ...
                          >
                            KSH 320K{" "}
                            <span className="text-yellow-400">(+540%)</span>
                          </motion.span>
                        </div>
                      </div>
                      <div className="mt-4 flex justify-center">
                  ...
                  <div className="flex justify-between items-center">
                    {[
                      ...
                      >
                        ...
                        <div className="font-tech font-bold text-hacker-green-bright text-sm">
                          {item.week}
                        </div>
                        <div className="text-xs text-hacker-green-dim">
                          {item.milestone}
            ...
            >
              <div className="glow-border rounded-lg p-6 bg-gradient-to-r from-purple-900/50 to-pink-900/50 backdrop-blur-sm max-w-4xl mx-auto text-center">
                ...
                <p className="text-lg text-hacker-green-bright mb-4">
                  Limited time offer: Get premium social media boosting at
                  unbeatable prices!
                </p>
                <motion.div
              ...
              {socialPlans.map((plan, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className="text-hacker-green-dim mb-6 capitalize font-tech">
                      per {plan.period}
                    </div>
            ...
            <div className="glow-border rounded-lg p-12 bg-gradient-to-br from-hacker-terminal/50 to-purple-900/30 backdrop-blur-sm text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-hacker-green-bright mb-8 max-w-2xl mx-auto leading-relaxed">
                  ...
                  who transformed their online presence with our
