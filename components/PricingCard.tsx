...
export default function PricingCard({ title, price, period, features, popular = false, delay = 0 }: PricingCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8">
        <h3 className="text-2xl font-tech font-bold text-hacker-green-bright mb-2 glow-text">{title}</h3>
        <div className="flex items-baseline justify-center gap-2">
          <span className="text-4xl font-tech font-bold text-hacker-green">{price}</span>
