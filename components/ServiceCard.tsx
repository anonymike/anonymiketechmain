...
export default function ServiceCard({ title, description, icon, features, delay = 0, link, badge }: ServiceCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      {badge && (
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            >
              <div className="text-white font-tech font-bold text-[8px] leading-tight">NEW</div>
              <div className="text-white font-tech font-bold text-[6px] leading-tight">SERVERS</div>
            </motion.div>
          </div>
      ...
      <div className="flex items-center gap-4 mb-4">
        <div className="text-hacker-green text-3xl group-hover:animate-pulse">{icon}</div>
        <h3 className="text-xl font-bold text-hacker-green-bright glow-text group-hover:animate-flicker">{title}</h3>
      </div>

      <p className="text-hacker-green-dim mb-4 leading-relaxed">{description}</p>
