  ...
  return (
    <>
      ...
      >
        ...
        >
          {isOpen ? <X className="w-6 h-6 text-hacker-green" /> : <Menu className="w-6 h-6 text-hacker-green" />}
        </button>
      </motion.div>
            ...
            >
              ...
              <div className="bg-gradient-to-r from-hacker-green/20 to-hacker-terminal p-6 border-b border-hacker-green">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-hacker-green rounded-lg flex items-center justify-center">
                    <span className="text-hacker-bg font-tech font-bold text-sm">A</span>
                  </div>
                  <div>
                    <h2 className="text-lg font-tech font-bold text-hacker-green-bright glow-text">ANONYMIKETECH</h2>
                    <p className="text-xs text-hacker-green-dim">Digital Innovation & Cyber Excellence</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-hacker-green/30">
                <div className="text-center space-y-3">
                  <p className="text-sm font-tech text-hacker-green-dim">Need Help?</p>
                  <a
